...
const generateProductItem = ({
  ...
  return {
    ...
    price: randomDecimalNumber(
      pizzaType ? (Number(pizzaType) * 150 + Number(size) * 2, 600) : 190,
      400
    ),
    pizzaType,
    size
...
async function up() {
  ...
  const pizza1 = await prisma.product.create({
    data: {
      name: 'Пепперони фреш',
      imageUrl: '/public/images/pizzas/Pepperoni_fresh.webp',
      categoryId: 1,
      ingredients: {
  ...
  const pizza2 = await prisma.product.create({
    data: {
      name: 'Сырная',
      imageUrl: '/public/images/pizzas/Cheese.webp',
      categoryId: 1,
      ingredients: {
  ...
  const pizza3 = await prisma.product.create({
    data: {
      name: 'Чоризо фреш',
      imageUrl: '/public/images/pizzas/Chorizo_fresh.webp',
      categoryId: 1,
      ingredients: {
